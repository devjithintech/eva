 ...
 *  PerformanceSection charts, rendered as an annual table for the subject
 *  fund. Sibling funds (real, from subject_fund.sibling_funds) are listed by
 *  name only — this dataset has no per-sibling annual-returns series. */
  ...
  return (
    <section id="returns" className="sec">
      ...
      <div className="sec-body">
        ...
        {!loading && data && (
          <div className="card">
            <div className="card-head" style={{ fontWeight: 650, fontSize: 15 }}>{fundName}</div>
